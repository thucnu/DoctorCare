...
const handleRegisterApi = (userEmail, userPassword, userFirstname, userLastname, userPhone) => {
    return axios.post('/api/register', { email: userEmail, password: userPassword, firstName: userFirstname, lastName: userLastname, phonenumber: userPhone});
}
...
export {
    handleLoginApi, handleLoginUserApi, handleRegisterApi, getAllUsers,
    ...
    getAllSpecialty, getAllDetailSpecialtyById, getAllPatientForDoctor,
    postSendRemedy, createNewHandbook, getAllHandbook,getAllDetailHandbookById,checkout
}